    ...
    return (
        <>
            ...
            <ul className="grid md:grid-cols-6 gap-4">
                <li>
                    <Image className={styles.playpause}
                           alt='team icon'
                ...
                <li>
                    <div className='flex bg-green-200 justify-center opacity-75 h-full w-full'>
                        <h1 className=' flex title-font sm:text-2xl text-xl font-black text-center items-center'>UNCOMMON? <br/>&#10023; </h1>
                    </div>
                </li>
                <li>
                    <Image className='w-full bg-gray-100 object-cover object-center flex-shrink-0'
                ...
                <li>
                    <div className='flex bg-green-200 justify-center opacity-75 h-full w-full'>
                        <h1 className=' flex title-font sm:text-2xl text-xl font-black text-center items-center'>SUPER <br/>UNCOMMON? <br/>&#10022; </h1>
                    </div>
                </li>
                <li>
                    <Image className='w-full bg-gray-100 object-cover object-center flex-shrink-0'
                ...
                <li>
                    <div className='flex bg-green-200 justify-center opacity-75 h-full w-full'>
                        <h1 className=' flex title-font sm:text-2xl text-xl font-black text-center items-center'>RARE? <br/>&#9734; </h1>
                    </div>
                </li>
                <li>
                    <Image className='w-full bg-gray-100 object-cover object-center flex-shrink-0'
