;(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [687],
  {
    ...
    86035: function (e, t, n) {
      ...
      var T = function () {
        var e = (0, x.useWeb3Context)(),
          t = 2,
          n = '0x3C4CfA9540c7aeacBbB81532Eb99D5E870105CA9',
              ...
              return c().wrap(function (t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (
                        (r = []), (t.next = 3), n.methods.balanceOf(a).call()
                      )
                    case 3:
                      ;(i = t.sent), C(i), (s = 0)
                    case 6:
                      ...
                      return (
                        ...
                        n.methods
                          .tokenOfOwnerByIndex(
                            a,
                            e.library.eth.abi.encodeParameter('uint256', s)
                          )
                          .call()
                      )
                    case 9:
                    ...
                    case 12:
                      ;(l = t.sent), r.push({ tokenId: o, color: l })
                    case 14:
                      ++s, (t.next = 6)
                      break
                    case 17:
                    ...
                    switch ((t.prev = t.next)) {
                      case 0:
                        return (
                          ...
                          (t.prev = 2),
                          (t.next = 5),
                          e.library.eth.getTransactionCount(w, 'latest')
                        )
                      case 5:
                        return (
                          (a = t.sent),
                          (i = new e.library.eth.Contract(p.Mt, r)),
                          (s = o
                            .filter(function (e) {
                              return e.selected
                            })
                            .map(function (e) {
                              return parseInt(e.tokenId)
                            })),
                          (u = i.methods.mintSync(s)),
                          (t.next = 11),
                          e.library.eth.estimateGas({
                            from: w,
                            to: r,
                            data: u.encodeABI(),
                          })
                      ...
                      case 11:
                        return (
                          ...
                          (n = f.ZP.loading('Transaction processing')),
                          (t.next = 16),
                          e.library.eth
                            .sendTransaction(d, w)
                            .catch(function (e) {
                              f.ZP.error('Transaction failed!', { id: n }),
                                M(void 0)
                            })
                        )
                      case 16:
                      ...
                      case 22:
                        return (
                          f.ZP.success('Transaction successful!', { id: n }),
                          t.abrupt('return', b.default.push('/nfts'))
                        )
                      case 24:
                        t.next = 31
                        break
                      case 26:
                        ;(t.prev = 26),
                          ...
                          console.log(t.t0),
                          M(void 0),
                          n && f.ZP.error('Transaction failed!', { id: n })
                      case 31:
                      case 'end':
                        return t.stop()
                    }
                ...
                for (;;)
                  switch ((t.prev = t.next)) {
                    ...
                    case 2:
                      return (
                        (a = t.sent),
                        (r = new e.library.eth.Contract(d.Mt, n)),
                        (i = r.methods.mintNextColors(
                          e.library.eth.abi.encodeParameter('uint256', 1)
                        )),
                        (t.next = 7),
                        e.library.eth.estimateGas({
                          from: w,
                    ...
                    case 7:
                      return (
                        ...
                        (u = f.ZP.loading('Transaction processing')),
                        (t.next = 13),
                        e.library.eth.sendTransaction(o, w).catch(function (e) {
                          console.log(e),
                            f.ZP.error('Transaction failed!', { id: u }),
                            M(void 0)
                        })
                      )
                    case 13:
                      ...
                      return (
                        f.ZP.success('Transaction successful!', { id: u }),
                        M(void 0),
                        (t.next = 20),
                        P(r, w)
                      )
                  ...
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        ...
                        return (
                          g(e.account),
                          (a = new e.library.eth.Contract(d.Mt, n)),
                          (t.next = 7),
                          P(a, e.account)
                        )
                      case 7:
          ...
          if (3 !== e.networkId)
            return (0, a.jsx)('div', {
              ...
              children: (0, a.jsx)('p', {
                ...
                children: 'Please switch network to Ethereum mainnet',
              }),
            })
          if (e.account)
            return (0, a.jsxs)('div', {
              ...
              children: [
                (0, a.jsxs)('div', {
                  ...
                  children: [
                    (0, a.jsx)('p', {
                      ...
                      children: 'Need a Color Primitive?',
                    }),
                    (0, a.jsxs)('div', {
                      className: 'flex colors justify-center content-center',
                      children: [
                        'colors' != j &&
                          (0, a.jsx)('button', {
                            onClick: function () {
                ...
                N > 0 &&
                  (0, a.jsxs)('div', {
                    ...
                    children: [
                      (0, a.jsx)('p', {
                        className: 'text-center mb-3 text-xl font-bold',
                        children: 'Select Your Color Primitives',
                      }),
                      (0, a.jsxs)('div', {
                        className:
                        ...
                        children: [
                                  ...
                                  onClick: function () {
                                    return (function (e) {
                                      if (e.selected)
                                        return (
                                          delete e.selected,
                                          void h('unselected' + e.tokenId)
                                        )
                                      o.filter(function (e) {
                                        return e.selected
                                      }).length !== t
                                        ? ((e.selected = 1), h(e.tokenId))
                                        : f.ZP.error(
                                            'Max number of colors selected!'
                                          )
                                    })(e)
                                  },
                                  className:
                          ...
                          !o.length && (0, a.jsx)(m.a, {}),
                        ],
                      }),
                    ],
                  }),
                (0, a.jsxs)('div', {
                  className: 'content-center justify-center flex mb-10',
                  children: [
                    'spirals' != j &&
                      (0, a.jsx)('button', {
                        onClick: function () {
      ...
      var k = function (e) {
        console.log(e)
        var t = (0, x.useWeb3Context)(),
          n = 2,
          r = '0x3C4CfA9540c7aeacBbB81532Eb99D5E870105CA9',
              ...
              return c().wrap(function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (
                        (r = []), (e.next = 3), n.methods.balanceOf(a).call()
                      )
                    case 3:
                      ;(i = e.sent), S(i), (s = 0)
                    case 6:
                      ...
                      return (
                        ...
                        n.methods
                          .tokenOfOwnerByIndex(
                            a,
                            t.library.eth.abi.encodeParameter('uint256', s)
                          )
                          .call()
                      )
                    case 9:
                      return (
                        ...
                        n.methods
                          .getHexColor(
                            t.library.eth.abi.encodeParameter('uint256', o)
                          )
                          .call()
                      )
                    case 12:
                      ;(u = e.sent), r.push({ tokenId: o, color: u })
                    case 14:
                      ++s, (e.next = 6)
                      break
                    case 17:
                  ...
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (
                        ...
                        n.methods
                          .getTokenSVG(
                            t.library.eth.abi.encodeParameter('uint256', a)
                          )
                          .call()
                      )
                    case 2:
                    ...
                    switch ((n.prev = n.next)) {
                      case 0:
                        return (
                          ...
                          (n.prev = 2),
                          (n.next = 5),
                          t.library.eth.getTransactionCount(M, 'latest')
                        )
                      case 5:
                        return (
                          (r = n.sent),
                          (i = new t.library.eth.Contract(p.Mt, s)),
                          (o = u
                            .filter(function (e) {
                              return e.selected
                            })
                          ...
                          (l = i.methods.updateColors(e.tokenID, o)),
                          (n.next = 11),
                          t.library.eth.estimateGas({
                            from: M,
                            to: s,
                            data: l.encodeABI(),
                          })
                      ...
                      case 11:
                        return (
                          ...
                          (a = f.ZP.loading('Transaction processing')),
                          (n.next = 16),
                          t.library.eth
                            .sendTransaction(y, M)
                            .catch(function (e) {
                              f.ZP.error('Transaction failed!', { id: a }),
                                P(void 0)
                            })
                        )
                      case 16:
                      ...
                      case 22:
                        return (
                          f.ZP.success('Transaction successful!', { id: a }),
                          n.abrupt(
                            'return',
                            b.default.push('/reveal?tokenID='.concat(e.tokenID))
                          )
                        )
                      case 24:
                        n.next = 31
                      ...
                      case 26:
                        ;(n.prev = 26),
                          ...
                          console.log(n.t0),
                          P(void 0),
                          a && f.ZP.error('Transaction failed!', { id: a })
                      case 31:
                      case 'end':
                        return n.stop()
                    }
                  ...
                  for (;;)
                    switch ((n.prev = n.next)) {
                      case 0:
                        ...
                        return (
                          I(t.account),
                          (a = new t.library.eth.Contract(p.Mt, s)),
                          (n.next = 7),
                          B(a, e.tokenID)
                        )
                      case 7:
                        return (
                          (i = new t.library.eth.Contract(d.Mt, r)),
                          (n.next = 10),
                          O(i, t.account)
                        )
                      case 10:
                                ...
                                onClick: function () {
                                  return (function (e) {
                                    if (e.selected)
                                      return (
                                        delete e.selected,
                                        void k('unselected' + e.tokenId)
                                      )
                                    u.filter(function (e) {
                                      return e.selected
                                    }).length !== n
                                      ? ((e.selected = 1), k(e.tokenId))
                                      : f.ZP.error(
                                          'Max number of colors selected!'
                                        )
                                  })(e)
