...
contract AirNFTStorage {
  ...
  address internal constant SYNCXCOLORS = address(0xdcc77c2c29280a262C6A9AB7dd3cfD317B86ab4f); // ROP
...
//  address(0x9fdb31F8CE3cB8400C7cCb2299492F2A498330a4); // Mainet
  ...
  address internal constant THE_COLORS = address(0x3C4CfA9540c7aeacBbB81532Eb99D5E870105CA9); // ROP
  //address internal constant THE_COLORS =
  //  address(0x9fdb31F8CE3cB8400C7cCb2299492F2A498330a4); // Mainet
