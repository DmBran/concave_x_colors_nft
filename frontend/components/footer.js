    ...
    return (
        <footer className={styles.footer}>
            ...
            <div className={"flex justify-center  flex-1 flex-grow text-center"}>
                <a className={styles.discord} target="_blank" href="https://discord.gg/nTf5q6MM">
                ...
                <a className={styles.icon} target="_blank" href="https://github.com/concave-dash/concave_x_colors_nft">
            ...
            <div className={"flex justify-center  flex-1 flex-grow text-center"}>
                <p className={'text-center text-sm mt-20 font-xs'}>
                    <span className={'block'}>DISCLAIMER</span> All purchases are final. This website makes no guarantees to be free from bugs and has associated risks.
                </p>
            </div>
        </footer>
    )
